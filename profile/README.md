...
<br>  
서버의 불안정함이 사용자들에게 피해를 주지 않도록 안정적인 전자상거래 서비스 제공을 위해 서버 이중화와 서비스 사용량에 따른 인프라 관리를 용이 하게 할 수 있는 MSA(Micro Service Architecture)로 설계하고 구현한 프로젝트입니다.
...
https://www.youtube.com/embed/BbUpgIDA174?si=MSXLbdjJFprryvhy
